  ...
  <div class="add">
    <section class="append">
      <ul>
        <li>
          <span>题目类型:</span>
          <el-select size="small" v-model="optionValue" placeholder="请选择题型" class="w150">
            <el-option
        ...
        <li v-if="optionValue == '选择题'">
          <span>难度等级:</span>
          <el-select size="small" v-model="postChange.level" placeholder="选择难度等级" class="w150">
            <el-option
        ...
        <li v-if="optionValue == '填空题'">
          <span>难度等级:</span>
          <el-select size="small" v-model="postFill.level" placeholder="选择难度等级" class="w150">
            <el-option
              v-for="item in levels"
              :key="item.value"
              :label="item.label"
        ...
        <li v-if="optionValue == '判断题'">
          <span>难度等级:</span>
          <el-select size="small" v-model="postJudge.level" placeholder="选择难度等级" class="w150">
            <el-option
              v-for="item in levels"
              :key="item.value"
              :label="item.label"
        ...
        <li v-if="optionValue == '选择题'">
          <span>正确选项:</span>
          <el-select size="small" v-model="postChange.rightAnswer" placeholder="选择正确答案" class="w150">
            <el-option
