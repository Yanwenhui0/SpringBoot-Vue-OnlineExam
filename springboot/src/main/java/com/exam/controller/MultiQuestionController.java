...
public class MultiQuestionController {
    ...
    @GetMapping("/multiQuestion/{ids}")
    public ApiResult findByIds(@PathVariable String ids) {
        List<MultiQuestion> multiQuestions = multiQuestionService.findByIds(ids);
        return ApiResultHandler.buildApiResult(200,"查询成功",multiQuestions);
    }
}
